...
public class Jatek_func_V11almenu implements ActionListener{

    private JFrame frame;
    private JLabel lblVissza;
    
    public static void main(String[] args) {
        new Jatek_func_V11almenu();
    }

    public Jatek_func_V11almenu() {
        ini();
    }
    ...
    private void ini(){
        ...
        /* almenü */
        JMenuItem menuItem = new JMenuItem("menü item");
        JMenu menu = new JMenu("Almenü");
        JMenuItem menuItem1 = new JMenuItem("menü item 1");
        JMenuItem menuItem2 = new JMenuItem("menü item 2");
        menu.add(menuItem1);
        menu.add(menuItem2);
        mnuEgyeb.add(menuItem);
        mnuEgyeb.add(menu);
        mnuEgyeb.add(new JCheckBoxMenuItem("Checkbox menu item"));
